package com.artemissoftware.capstoneexperience.screens.login
...
fun UserForm(
    ...
    val email = rememberSaveable { mutableStateOf("") } //remembers values beyond configuration changes (ex: rotate phone)
